    ...
    return (
        <div className={styles.caution_modal}>
            ...
            <div className={styles.caution_modal_text}>
                ...
                <p>There is a minimum donation to mint and receive a Mutable PFP NFT into your Web3.0 wallet. Always double check the amount input in your transaction while minting. <b>Only you are responsible for any loss of funds.</b></p>
                <p>Any and every blockchain interaction and/or any interaction on this website (especially with the image uploader) and thereby the InterPlanetary File System is intended to and will be considered public. <b>Anything uploaded and shared on IPFS is publicly accessible and has the potential to become permanent.</b></p>

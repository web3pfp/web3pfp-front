    ...
    return (
        <div className={styles.legal_content}>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to Web3PFP, accessible from <a href="web3pfp.me"
                                                                                      rel="external nofollow noopener"
                                                                                      target="_blank">web3pfp.me</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__"
                                 data-cfemail="235446411053455363534e0d4e46">[email&#160;protected]</a></li>
            </ul>
